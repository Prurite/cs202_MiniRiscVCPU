...
main:
    ...
    # Read the input integer
                  # System call number for ReadInt
    addi a0, zero, 100               # Perform system call to read the integer
    ...
    #mv a0, t2            The final program should have this instruction instead of the one in line23
                  # System call number for PrintInt
                     # Print the result

    # Exit the program
    j end             # System call number for exit
