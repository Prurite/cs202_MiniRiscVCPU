...
set_property PACKAGE_PIN G2 [get_ports {seg_sel0[0]}]
set_property PACKAGE_PIN C2 [get_ports {seg_sel0[1]}]
set_property PACKAGE_PIN C1 [get_ports {seg_sel0[2]}]
set_property PACKAGE_PIN H1 [get_ports {seg_sel0[3]}]
set_property PACKAGE_PIN G1 [get_ports {seg_sel1[0]}]
set_property PACKAGE_PIN F1 [get_ports {seg_sel1[1]}]
set_property PACKAGE_PIN E1 [get_ports {seg_sel1[2]}]
set_property PACKAGE_PIN G6 [get_ports {seg_sel1[3]}]